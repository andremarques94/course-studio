...
import {
	...
	SheetHeader,
	SheetTitle,
} from "@course-studio/ui/components/sheet";
...
function SidebarProvider({
	...
	const setOpen = React.useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			// biome-ignore lint/suspicious/noDocumentCookie: This is a shadcn component and it is safe to use document.cookie here.
	...
	// biome-ignore lint/correctness/useExhaustiveDependencies: This is a shadcn component and it is safe to use document.cookie here.
